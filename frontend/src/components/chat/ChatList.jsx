                ...
                <nav className="flex w-full flex-col" aria-label="Tabs" role="tablist" aria-orientation="horizontal">
                    {
                        Array.from({ length: 10 }, (_, index) => (
                            <div key={index} type="button" className="hover:bg-gray-100 border-b border-gray-100 cursor-pointer transition-all hs-tab-active:text-blue-600 py-4 px-5 flex text-sm text-gray-500 active" id="vertical-tab-with-border-item-1" aria-selected="true" data-hs-tab="#vertical-tab-with-border-1" aria-controls="vertical-tab-with-border-1" role="tab">
                                <div className='flex gap-x-2 justify-between w-full'>
                                    ...
                                    <div className='w-[calc(100%-60px)] flex flex-col gap-y-1'>
                                        <div className='flex items-center justify-between'>
                                            <span className='font-medium text-[13px] text-gray-800'>John Doe</span>
                                            <span className='text-[10px] uppercase text-gray-400'>1M</span>
                                        </div>
                                        <div className='flex items-center justify-between'>
                                            <span className='font-light truncate text-xs text-gray-500 leading-4'>Telegram chat</span>
